...
@Component({
  ...
  templateUrl: './caja-grande.component.html',
  styleUrls: ['./caja-grande.component.scss'],
})
export class CajaGrandeComponent implements OnInit {
  constructor(
    ...
    this.app.currentSection = ' - Bancos';
  }
  archivo;
  excel: any = [];
  movimiento: any = {};
